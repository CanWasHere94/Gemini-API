...
prompt = f"Analyze the content given below in terms of content moderation and return '1' if it's suitable to be released in a website or return '0'. Content: '{user_text}'"
